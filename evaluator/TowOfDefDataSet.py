...
for i in range(0,500,1):
    ...
    testData.append(row)
'''
# testData.append(data_parsing.getData('sample_log'))
clf = SVC()
...
def getDF(json_file_path):
    print testData.append(data_parsing.getData(json_file_path))
    d = clf.predict(testData)
    return d[0], d[0]
